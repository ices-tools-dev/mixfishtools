...
Two main objects used by the `plot_overUnderFltStk` function: a `data` object and a `refTable` object containing information on plotting colors for added consistency across several subsequent plots. 
